...
namespace LadeviVentasApi.Data.Migrations
{
    ...
    [Migration("20190701054849_AddedClientsFieldsAndRelatedEntities")]
    partial class AddedClientsFieldsAndRelatedEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.Client", b =>
                {
                    ...
                    b.Property<string>("GrossIncomeTaxCode")
                        .IsRequired()
                        .HasMaxLength(30);
                    ...
                    b.Property<string>("TaxIdentificationCode")
                        .IsRequired()
                        .HasMaxLength(30);

                    b.Property<long>("TaxIdentificationTypeId");

                    b.Property<long>("TaxIvaCategoryId");

                    b.Property<long>("TaxJuridisctionTypeId");
                    ...
                    b.HasIndex("TaxIdentificationTypeId");

                    b.HasIndex("TaxIvaCategoryId");

                    b.HasIndex("TaxJuridisctionTypeId");
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.TaxIdentificationType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TaxIdentificationType");
                });

            modelBuilder.Entity("LadeviVentasApi.Models.Domain.TaxIvaCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TaxIvaCategory");
                });

            modelBuilder.Entity("LadeviVentasApi.Models.Domain.TaxJuridisctionType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.Client", b =>
                {
                    ...
                    b.HasOne("LadeviVentasApi.Models.Domain.TaxIdentificationType", "TaxIdentificationType")
                        .WithMany()
                        .HasForeignKey("TaxIdentificationTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LadeviVentasApi.Models.Domain.TaxIvaCategory", "TaxIvaCategory")
                        .WithMany()
                        .HasForeignKey("TaxIvaCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LadeviVentasApi.Models.Domain.TaxJuridisctionType", "TaxJuridisctionType")
                        .WithMany()
                        .HasForeignKey("TaxJuridisctionTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
