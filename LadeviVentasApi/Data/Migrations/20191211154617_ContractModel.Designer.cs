...
namespace LadeviVentasApi.Data.Migrations
{
    ...
    [Migration("20191211154617_ContractModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.ClientTaxes", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.PublishingOrder", b =>
                {
                    ...
                    b.Property<long>("SoldSpaceLocationId");
                    ...
                    b.HasIndex("SoldSpaceLocationId");
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.SoldSpaceLocation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.ClientTaxes", b =>
                {
                    b.HasOne("LadeviVentasApi.Models.Domain.Client")
                        .WithMany("ClientTaxes")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LadeviVentasApi.Models.Domain.TaxType", "TaxType")
                        .WithMany()
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.ProductCurrencyParity", b =>
                {
                    b.HasOne("LadeviVentasApi.Models.Domain.Product")
                        .WithMany("ProductCurrencyParities")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("LadeviVentasApi.Models.Domain.PublishingOrder", b =>
                {
                    ...
                    b.HasOne("LadeviVentasApi.Models.Domain.SoldSpaceLocation", "SoldSpaceLocation")
                        .WithMany()
                        .HasForeignKey("SoldSpaceLocationId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
