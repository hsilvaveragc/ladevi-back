...
public class RestController<T> : RestController<T, T> where T : BaseEntity
{
    public RestController(ApplicationDbContext context, IMapper mapper) : base(context, mapper)
    {
    }
}

[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
public class RestController<T, TWrite> : ControllerBase
    where T : BaseEntity
    where TWrite : BaseEntity
{
    ...
    public RestController(ApplicationDbContext context, IMapper mapper)
    {
        Context = context;
        Mapper = mapper;
